...
#set terminal svg enhanced font 'Helvetica,11' size 4,3
set terminal svg enhanced font 'Helvetica,16' size 420,600
set encoding utf8
...
# set key options
set key top right width -3 height 0 font 'Helvetica, 14'
...
set mytics 10
set grid layerdefault linetype -1 linecolor rgb "#000000" linewidth 0.200, linetype 0 linecolor rgb "#000000"  linewidth 0.100
set samples 300, 300
...
set output "./bfer_6144.svg"
# set multiplot layout 1,2 title "{/:Bold=11 LTE-A Turbo decoding performances (K = 6144, 6 iters, R=1/3)}" offset 0,-0.02
#set multiplot layout 1,2

set title "Decoding performances" offset 0,-0.02

datafile = "./data_6144.txt"
...
# set key off
set xlabel "E_b/N_0 (dB)"
set ylabel "Frame Error Rate (FER)"
